...
const handleSubmit = async function(data:any) {
  ...
  <section class="dark:bg-gray-900">
    <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
      <h1 class="mb-4 text-6xl tracking-tight font-extrabold text-center dark:text-white">Contact Us</h1>
      <p class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Have any technical issue, questions, or suggestions? Let us know.</p>
      ...
      <form on:submit|preventDefault={handleSubmit} class="space-y-8">
        ...
        <textarea name="message" required rows="8" placeholder="Message" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light"></textarea>
        </div>
        <input type="submit" class="py-3 px-5 text-md font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800  focus:border bg-secondary"/>
      </form>
      </div>
      </section>
